...
const matrixAsClass = new permissions_matrix_1.Permissions();
matrixAsClass.allow({
...
describe.each([['as object', matrixAsObject], ['as class', matrixAsObject]])('Given: matrix defined as %s', (_description, matrixDef) => {
