...
__decorate([
    decorators_2.AuthorizerTreatAs(types_1.Resource.User),
...
describe('Unit: @AuthorizeTreatAs', () => {
    test('Decorating an attribute adds that attribute to the metadata map under specified resource', () => {
        ...
        __decorate([
            decorators_2.AuthorizerTreatAs(types_1.Resource.Division),
            __metadata("design:type", String)
        ], Foo.prototype, "some_attribute", void 0);
        const foo = new Foo('bar');
        const retrievedMetadata = Reflect.getMetadata(decorators_1.AuthResourceSymbol, foo);
    ...
    test.skip('Decorating a parameter adds that attribute to the metadata map under specified resource', () => {
        ...
        Foo = __decorate([
            __param(0, decorators_2.AuthorizerTreatAs(types_1.Resource.Division)),
...
describe('Unit: getAuthorizerTreatAs', () => {
    test('It inflects; returning a Map populated with all ResourceIds that match the passed `authorizable`', () => {
        ...
        const map = decorators_2.getAuthorizerTreatAs(undecoratedAuthorizable);
...
describe('Unit: AuthorizerTreatAsMap', () => {
    test('It can be instatiated with a new Map()-like parameter', () => {
        const map = new decorators_1.AuthorizerTreatAsMap([[types_1.Resource.Division, ['hashid']]]);
    ...
    test('It can be instatiated with deprecated object-like parameter ', () => {
        const map = new decorators_1.AuthorizerTreatAsMap({
            [types_1.Resource.Division]: ['hashid']
        });
        expect(map.get(types_1.Resource.Division).has('hashid')).toBe(true);
    });
