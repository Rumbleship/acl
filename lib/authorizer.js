...
exports.Authorizer = exports.AuthorizerAbstract = void 0;
...
class AuthorizerAbstract {
    ...
    get on_behalf_of() {
        var _a, _b;
        if ((_a = this._claims) === null || _a === void 0 ? void 0 : _a.on_behalf_of) {
            return new oid_1.Oid((_b = this._claims) === null || _b === void 0 ? void 0 : _b.on_behalf_of);
        }
        return undefined;
    }
    get scopes() {
...
AuthorizerAbstract._initialized = false;
__decorate([
    required_decorator_1.Required(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], AuthorizerAbstract.prototype, "authenticate", null);
__decorate([
    required_decorator_1.Requires('authenticate'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", String)
], AuthorizerAbstract.prototype, "getUser", null);
__decorate([
    required_decorator_1.Requires('authenticate'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Object)
], AuthorizerAbstract.prototype, "getOnBehalfOf", null);
__decorate([
    required_decorator_1.Requires('authenticate'),
    __metadata("design:type", Function),
...
], AuthorizerAbstract.prototype, "can", null);
__decorate([
    required_decorator_1.Requires('authenticate'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Array)
], AuthorizerAbstract.prototype, "identifiersThatCan", null);
__decorate([
    required_decorator_1.Requires('authenticate'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Boolean)
], AuthorizerAbstract.prototype, "inScope", null);
exports.AuthorizerAbstract = AuthorizerAbstract;
class Authorizer extends AuthorizerAbstract {
}
