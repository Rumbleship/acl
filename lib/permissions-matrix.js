...
exports.Permissions = exports.ResourceActionsMap = exports.ResourceAsScopesSingleton = void 0;
 ...
 */
exports.ResourceAsScopesSingleton = new Map([
...
class Permissions extends Map {
     ...
     */
    allow({ role, at, to }) {
        const resource = exports.ResourceAsScopesSingleton.get(at);
